...
def main():
    ...
    # 2) Filtrar por provincia Picota (ya estandarizada en mayusculas en el dataset limpio)
    df = df[df['PROVINCIA'] == 'PICOTA']
    ...
    ax.set_title('Agrupamiento DBSCAN por SEGUNDOS (Picota)')
