# DbscanSanMartin/MARISCAL_CASERES.py
import pandas as pd
...
def main():
    ...
    # 2) Filtrar por provincia Mariscal Caceres (ya estandarizada en mayusculas en el dataset limpio)
    df = df[df['PROVINCIA'] == 'MARISCAL CACERES']
    ...
    ax.set_title('Agrupamiento DBSCAN por SEGUNDOS (Mariscal Caceres)')
