...
def main():
    ...
    # 2) Filtrar por provincia Mariscal Cáceres
    df = df[df['PROVINCIA'].str.upper().fillna('') == 'MARISCAL CACERES']
    ...
    ax.set_title('Agrupamiento DBSCAN por SEGUNDOS (Mariscal Cáceres)')
