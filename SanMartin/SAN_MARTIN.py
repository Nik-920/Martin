...
def main():
    ...
    # 2) Filtrar por provincia San Martin (ya estandarizada en mayusculas en el dataset limpio)
    df = df[df['PROVINCIA'] == 'SAN MARTIN']
    ...
    # 7) Ejecutar DBSCAN
    # 7) Aplicar DBSCAN (eps=0.14, min_samples=16)
    # 7) Aplicar DBSCAN (eps=0.15, min_samples=22)
    dbscan = DBSCAN(eps=0.152, min_samples=22)
    ...
    ax.set_title('Agrupamiento DBSCAN por SEGUNDOS (San Martin)')
